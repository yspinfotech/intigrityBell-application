...
class _AddEventScreenState extends State<AddEventScreen> {
      ...
      builder: (context) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              Text('Select Alarm Sound', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
              SizedBox(height: 20),
              _buildSoundOption(
  ...
  Widget _buildSoundOption({required IconData icon, required String title, required String value, required VoidCallback onTap}) {
    ...
    return ListTile(
      leading: Icon(icon, color: isSelected ? Color(0xFF2ECC71) : Colors.grey),
      title: Text(title, style: TextStyle(color: isSelected ? Colors.white : Colors.grey[400])),
      trailing: isSelected ? Icon(Icons.check, color: Color(0xFF2ECC71)) : null,
      onTap: onTap,
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              // Date Picker
              Text('Date', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w600)),
              SizedBox(height: 8),
              GestureDetector(
                onTap: () async {
                ...
                children: [
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Start Time', style: TextStyle(color: Colors.white, fontSize: 14)),
                        SizedBox(height: 8),
                        GestureDetector(
                          onTap: () async {
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('End Time', style: TextStyle(color: Colors.white, fontSize: 14)),
                        SizedBox(height: 8),
                        GestureDetector(
                          onTap: () async {
                            final picked = await showTimePicker(
              ...
              SizedBox(height: 20),
              // Sound Selection
              Text('Alarm Sound', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w600)),
              SizedBox(height: 8),
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.music_note, color: Color(0xFF2ECC71), size: 20),
                          SizedBox(width: 12),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
              ...
              Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Repeat Alarm', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w600)),
                      Switch(
                        value: _isRepeating,
                        onChanged: (value) {
                          setState(() {
                      ...
                      children: List.generate(7, (index) {
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            height: 40,
                            decoration: BoxDecoration(
                              color: isSelected ? Color(0xFF2ECC71) : Color(0xFF2A2F3F),
